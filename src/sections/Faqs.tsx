                ...
                <div className="mt-12 flex flex-col gap-6 max-w-xl mx-auto">
                    {faqs.map((faq, faqIndex) => (
                        <div key={faq.question} className="bg-neutral-900 rounded-2xl border border-white/10 p-6 ">
                            <div className="flex flex-row justify-between items-center " onClick={() => setSelectedindex(faqIndex)}>
                                ...
                                <svg
                                    ...
                                    className={twMerge("feather feather-plus text-lime-400 flex-shrink-0 transition duration-300 cursor-pointer", selectedindex === faqIndex && 'rotate-45')}
                                >
