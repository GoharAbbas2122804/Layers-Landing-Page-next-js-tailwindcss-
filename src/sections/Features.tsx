...
import avatar4 from "@/assets/images/avatar-florence-shaw.jpg";
                ...
                <div className="mt-12 grid grid-cols-1 md:grid-cols-4 lg:grid-cols-3 gap-8">
                    ...
                    >
                        <div className="aspect-video flex items-center justify-center">
                            ...
                            <Avatar className="-ml-6 border-neutral-600">
                                <div className="size-full bg-neutral-800 rounded-full flex flex-col items-center justify-center gap-1.5 p-3">
                                    {[1, 2, 3].map((dot) => (
                                        <span 
                                            key={dot} 
