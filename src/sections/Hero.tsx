    ...
    return (
        <section className="py-24 overflow-x-clip" style={{
            ...
            <div className="container relative">
                ...
                <motion.div ref={rightPointerScope} initial={{opacity: 0, y:100 , x:200}} className="absolute right-80 -top-4 hidden lg:block">
                    <Pointer name="Abbas" color="red" /> 
                </motion.div>
                ...
                <h1 className="text-6xl font-medium text-center mt-6 lg:text-8xl">
                    Impactful Design , created effortlessly
                </h1>
                <p className="text-center text-xl text-white/50 mt-8 max-w-2xl mx-auto">
                    Design tools shouldn&apos;t slow you down.Layers combines
                    powerful features with intuitive interface keeps in your
                    creative workflow.
                </p>

                <form className="flex flex-col sm:flex-row gap-2 border border-white/15 rounded-full p-2 mt-8 max-w-lg mx-auto w-full">
                    <input
                        type="email"
                        placeholder="Enter your email"
                        className="bg-transparent px-4 py-2 sm:py-0 w-full sm:w-auto sm:flex-1 min-w-0 active:border-none"
                    />
                    <Button
                        variant="primary"
                        size="sm"
